...
type
  ...
  TReturnViewFrombase = class(TForm)
    ...
    btnCancel: TButton;
    btnOK: TButton;
    edtComWeChat: TcxImageComboBox;
    edtAge: TcxTextEdit;
    edtphone: TcxTextEdit;
    edtFoodCycle: TcxTextEdit;
    edtFuzeren: TcxTextEdit;
    RemarkMemo: TcxMemo;
    edtName: TcxTextEdit;
    edtCardNum: TcxTextEdit;
  private
...
var
  ReturnViewFrombase: TReturnViewFrombase;
